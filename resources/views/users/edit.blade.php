            ...
            <p class="mt-1 text-sm/6 text-gray-400">We just need some details here.</p>
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input id="first_name" type="text" :value="old('first_name', $user->first_name)" name="first_name" required />
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input id="last_name" type="text" :value="old('last_name', $user->last_name)" name="last_name" required/>
                    ...
                    <x-form-field>
                        ...
                        <div class="mt-2">
                            <x-form-input id="email" type="email" name="email" :value="old('email', $user->email)" placeholder="jhon.doe@mail.com" required/>
                    ...
                    <!-- ---------------------------------------------------------- -->
                        ...
                        <x-form-field class="">
                            ...
                            <div class="mt-2">
                                ...
                                <x-form-textarea
                                    ...
                                    >{{ old('description', $user->employer->description) }}</x-form-textarea>
                            </div>
                        </x-form-field>
                        ...
                        <x-form-label for="website">Website</x-form-label>
                            <div class="mt-2">
                                <x-form-input id="website" placeholder="www.mycompany.com" type="text" :value="old('website', $user->website)" name="website"/>
